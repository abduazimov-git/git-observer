...
if ENV:
    ...
    GIT_REPO_URL = environ.get('GIT_REPO_URL', "https://github.com/abduazimov-git/git-observer")
else:
...
print("If you need more help, join @Dasturchilar_Groups in Telegram.")
...
def support(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*Getting Support*\n\nTo get support in using the bot, join [the GitHub Observer support](https://t.me/null).",
        parse_mode="markdown"
    )
...
def source(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*Source*:\n[Git-Observer Repo](https://github.com/abduazimov-git).",
        parse_mode="markdown"
    )
